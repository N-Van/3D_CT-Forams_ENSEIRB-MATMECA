...
def napari_predictions(tif_path, predicted_data_file_path, rectangle):
    ...
    #--------------------------------------------------------------------------------------------------------------------------
    # Display the points corresponding to the predictions in Napari
    #--------------------------------------------------------------------------------------------------------------------------

    file_path = predicted_data_file_path
    ...
    colors = cm.coolwarm(conf_norm)[:, :3]
    with napari.gui_qt():
        viewer.add_points(points, size=5, face_color=colors, name='Foram predicted')
        
        # fig, ax = plt.subplots(figsize=(4, 0.5))
        # norm = plt.Normalize(vmin=conf.min(), vmax=conf.max()) 
...
if __name__ == "__main__":
    ...
    parser.add_argument('predicted_data_file_path', type=str, help='Path to the input file containing the locations of the predicted forams.')
    ...
    napari_predictions(args.tif_path, args.predicted_data_file_path, args.rectangle)