...
def apply_hdbscan(prediction_file_path, annotated_data_file_path, minSamples, minClusterSize):
    ...
    # Load the points from .csv files into a dataframe
    ...
    df_with_clusters = points_df.copy()
    ...
    # # Calculate the number of clusters in the annotated rectangle
    # num_clusters = 0
    # data_with_clusters = df_with_clusters[['x_Foram_Pix','y_Foram_Pix','z_Foram_Pix', 'cluster']].values
    # data_in_retangle = []
    # for pt in data_with_clusters:
    #     if (pt[0]>362 and pt[0]<1538 and pt[1]>362 and pt[1]<1538):
    #         data_in_retangle.append(pt)
    # col = [ligne[3] for ligne in data_in_retangle]
    ...
    # # Aq1T0 : Number of foram counted/annotated in the dataset -> in the rectangle !
...
if __name__ == "__main__":
    ...
    apply_hdbscan(args.prediction_file_path, args.annotated_data_file_path, args.minSamples, args.minClusterSize)