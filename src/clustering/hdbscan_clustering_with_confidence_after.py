...
def apply_hdbscan(prediction_file_path, annotated_data_file_path, minSamples, minClusterSize, threshold):
    ...
    # filtered_df = points_df[points_df['conf'] >= threshold]

    # # Extract the 'x_Foram_Pix', 'y_Foram_Pix', 'z_Foram_Pix' coordinates
    # points = filtered_df[['x_Foram_Pix', 'y_Foram_Pix', 'z_Foram_Pix']].values
    ...
    num_clusters = 0
    data_with_clusters = filtered_df[['x_Foram_Pix','y_Foram_Pix','z_Foram_Pix', 'cluster']].values
